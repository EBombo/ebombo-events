    ...
    <>
      {props.google && (
        ...
        >
          ...
          <div className="label">{props.googleLabel ? props.googleLabel : "Ingresar con Google"}</div>
        </ButtonsCss>
      )}
      {props.facebook && (
        <ButtonsCss
        ...
        >
          ...
          <div className="label">{props.facebookLabel ? props.facebookLabel : "Ingresar con Facebook"}</div>
        </ButtonsCss>
      )}
    </>
  );
