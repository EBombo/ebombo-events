...
export const TeamBuilding = (props) => {
  ...
  const GameContentItem = ({ gameContent }) => (
    <div>
            ...
            <Carousel
              ...
              components={TeamBuildingLiterals.games.map((_, index) => (
                <div
                  ...
                  className="grid grid-cols-[1fr] md:grid-cols-[1fr_1fr_1fr] gap-8"
                >
                  <GameContentItem
                    gameContent={TeamBuildingLiterals.games[index % TeamBuildingLiterals.games.length]}
                  />

                  <Desktop>
                    <>
                      <GameContentItem
                        gameContent={TeamBuildingLiterals.games[(index + 1) % TeamBuildingLiterals.games.length]}
                      />

                      <GameContentItem
                        gameContent={TeamBuildingLiterals.games[(index + 2) % TeamBuildingLiterals.games.length]}
                      />
                    </>
                  </Desktop>
                </div>
