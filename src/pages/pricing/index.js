    ...
    <div>
      <div className="p-4 bg-whiteDark bg-cover bg-no-repeat bg-pattern-gray w-[100vw] md:p-8">
        <div className="grid gap-4 md:grid-cols-[50%_50%] items-end">
          <div>
            <div className="text-[30px] text-secondary leading-[34px] font-[700] mb-4">{t("title")}</div>
            <div className="text-[18px] text-secondary leading-[22px] font-[400] mb-4">{t("description")}</div>
          </div>
              ...
              <div className="bg-whiteLight rounded-[6px] shadow-[0_0_9px_rgba(0,0,0,0.25)] p-4 min-h-[600px] max-w-[350px]">
                <div className="flex items-center gap-4">
                  <Image
                    ...
                    margin="0"
                  />
                  <div className="text-[24px] leading-[29px] text-secondary font-[700]">{t("pro-hosted")}</div>
                </div>
                <div className="text-[16px] leading-[19px] my-4 text-secondary">{t("pro-hosted-description")}</div>
                <div>
                  <ButtonAnt
                    color="orangeLight"
                    margin="1rem 0"
                ...
                <div className="bg-gray rounded-[6px] p-2 min-h-[300px]">
                  ...
                  <ul>
                    {[...Array(10).keys()].map((num) => (
                      <li
                        key={num}
                        className="font-[400] text-secondary text-[14px] leading-[17px] flex gap-[5px] my-2"
                      >
                        {num < 9 && <CheckOutlined />}
                        {t(`pro-hosted-${num + 1}`)}
                      </li>
              ...
              <div className="bg-whiteLight rounded-[6px] shadow-[0_0_9px_rgba(0,0,0,0.25)] p-4 min-h-[600px] max-w-[350px]">
                <div className="flex items-center gap-4">
                  <Image
                    ...
                    margin="0"
                  />
                  <div className="text-[24px] leading-[29px] text-secondary font-[700]">{t("subscription")}</div>
                </div>
                <div className="text-[16px] leading-[19px] my-4 text-secondary">{t("subscription-description")}</div>
                <div>
                  <ButtonAnt
                    color="success"
                    margin="1rem 0"
              ...
              <div className="bg-whiteLight rounded-[6px] shadow-[0_0_9px_rgba(0,0,0,0.25)] p-4 max-w-[350px]">
                <div className="flex items-center gap-4">
                  <Image
                    ...
                    margin="0"
                  />
                  <div className="text-[24px] leading-[29px] text-secondary font-[700]">{t("auto-hosted")}</div>
                </div>
                <div className="text-[16px] leading-[19px] my-4 text-secondary">{t("auto-hosted-description")}</div>
                <div>
                  <ButtonAnt
                    color="orangeLight"
                    margin="1rem 0"
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-[10px] justify-center">
              {hostedGames.map((game, index) => (
                <div
                  key={`${game}-${index}`}
                  className="rounded-[6px] w-[160px] md:w-[180px] h-[110px] shadow-[0_0_4px_rgba(0,0,0,0.25)] bg-whiteLight"
                >
