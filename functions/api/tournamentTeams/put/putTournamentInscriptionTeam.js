...
exports.putTournamentInscriptionTeam = async (req, res, next) => {
    logger.log("put tournamentTeam inscription user->", req.params);
    ...
    try {
        ...
        await saveTournamentTeam(tournament, user, entryCost);
...
const saveTournamentTeam = async (tournament, user, entryCost) => {
